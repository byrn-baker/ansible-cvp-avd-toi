...
ntp server vrf MGMT 192.168.0.2 prefer
ntp server vrf MGMT 192.168.0.3
```
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_PEER_DC1-LEAF1B_Ethernet1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
| Ethernet4 |  server01_Eth0 | access | 12 | - | - | - |
| Ethernet6 | MLAG_PEER_DC1-LEAF1B_Ethernet6 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
...
!
interface Ethernet6
   description MLAG_PEER_DC1-LEAF1B_Ethernet6
   no shutdown
   channel-group 1 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | MLAG_PEER_DC1-LEAF1B_Po1 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
| Vlan3009 |  Tenant_A_OP_Zone  |  10.255.254.0/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3010 |  Tenant_A_WEB_Zone  |  10.255.254.0/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3011 |  Tenant_A_APP_Zone  |  10.255.254.0/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3012 |  Tenant_A_DB_Zone  |  10.255.254.0/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3013 |  Tenant_A_WAN_Zone  |  10.255.254.0/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3019 |  Tenant_B_OP_Zone  |  10.255.254.0/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3020 |  Tenant_B_WAN_Zone  |  10.255.254.0/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3029 |  Tenant_C_OP_Zone  |  10.255.254.0/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3030 |  Tenant_C_WAN_Zone  |  10.255.254.0/31  |  -  |  -  |  -  |  -  |  -  |
...
| 10.255.254.1 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_A_OP_Zone |
...
| 10.255.254.1 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_B_OP_Zone |
| 10.255.254.1 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_B_WAN_Zone |
| 10.255.254.1 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_C_OP_Zone |
| 10.255.254.1 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_C_WAN_Zone |
...
| Tenant_A_DB_Zone | 192.168.255.1:13 | 13:13 | - | - | learned | 140-141 |
| Tenant_A_NFS | 192.168.255.1:10161 | 10161:10161 | - | - | learned | 161 |
| Tenant_A_OP_Zone | 192.168.255.1:10 | 10:10 | - | - | learned | 12,110-112 |
| Tenant_A_VMOTION | 192.168.255.1:55160 | 55160:55160 | - | - | learned | 160 |
| Tenant_A_WAN_Zone | 192.168.255.1:14 | 14:14 | - | - | learned | 150 |
| Tenant_A_WEB_Zone | 192.168.255.1:11 | 11:11 | - | - | learned | 120-121 |
| Tenant_B_OP_Zone | 192.168.255.1:20 | 20:20 | - | - | learned | 210-211 |
| Tenant_B_WAN_Zone | 192.168.255.1:21 | 21:21 | - | - | learned | 250 |
| Tenant_C_OP_Zone | 192.168.255.1:30 | 30:30 | - | - | learned | 310-311 |
| Tenant_C_WAN_Zone | 192.168.255.1:31 | 31:31 | - | - | learned | 350 |
...
| Tenant_A_DB_Zone | 192.168.255.1:13 | connected |
| Tenant_A_OP_Zone | 192.168.255.1:10 | connected |
| Tenant_A_WAN_Zone | 192.168.255.1:14 | connected |
| Tenant_A_WEB_Zone | 192.168.255.1:11 | connected |
| Tenant_B_OP_Zone | 192.168.255.1:20 | connected |
| Tenant_B_WAN_Zone | 192.168.255.1:21 | connected |
| Tenant_C_OP_Zone | 192.168.255.1:30 | connected |
| Tenant_C_WAN_Zone | 192.168.255.1:31 | connected |
...
router bgp 65101
   ...
   neighbor 10.255.254.1 description DC1-LEAF1B
